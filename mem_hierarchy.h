...
#define RAM_SIZE 256 * 1024 // Bytes

#define CACHE_TYPE "WB"
#define CACHE_SIZE 16 * 1024 // Bytes
...
#define OFFSET_MASK  ~(0xffffffff << OFFSET_SIZE)
#define TAG_MASK 0xffffffff << (OFFSET_SIZE + INDEX_SIZE)
#define INDEX_MASK (0xffffffff & ~TAG_MASK) & ~OFFSET_MASK
